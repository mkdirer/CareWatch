package com.myapp.carewatch.screens.profile
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        currentUserViewModel = ViewModelProvider(requireActivity()).get(com.myapp.carewatch.view_models.CurrentUserViewModel::class.java)
